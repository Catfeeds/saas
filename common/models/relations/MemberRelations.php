 ...
 */
    ...
    {
        return $this->hasOne(EntryRecord::className(),['member_id'=>'id'])->orderBy(["entry_time"=>SORT_DESC]);
    }
    ...
    public function getAdminLog(){
        return $this->hasOne(AdminLog::className(), ['id'=>'user_id']);
    }
     ...
     * @return \yii\db\ActiveQuery
     */
    public function getIcBindingRecord(){
        return $this->hasOne(IcBindingRecord::className(), ['member_id'=>'id'])->onCondition(["icBindingRecord.status"=>1]);
    }
    public function getIcBindingRecordS(){
        return $this->hasOne(IcBindingRecord::className(), ['member_id'=>'id']);
    }
     ...
     * @return \yii\db\ActiveQuery
     */
    public function getPrivater()
    {
        return $this->hasOne(Employee::className(), ['id'=>'private_id']);
    }
    ...
    {
        return $this->hasOne(\backend\models\FollowMember::className(), ['member_id'=>'id'])->onCondition(["operation"=>0]);
    }
