...
trait MemberCardRelations
{
    ...
    public function getLeaveRecordOneMemberCard(){
        return $this->hasOne(LeaveRecord::className(), ['member_card_id'=>'id'])->onCondition(['and', ['le.type' => 2], ['le.status' => 1]]);
    }
    /**
     * 会员卡表 关联会员 请假表 （ios）
     * @author 侯凯新 <houkaixin@itsports.club>
    ...
    public function getDeal(){
        return $this->hasOne(MemberDealRecord::className(),['id'=>'deal_id'])->onCondition(['or',['>=','deal.create_at',1527782400],['<>','deal.company_id',1]]);
    }
     ...
     * @return mixed
     */
    public function getAboutClassTab()
    {
        return $this->hasMany(AboutClass::className(), ['member_card_id' => 'id']);
    }
}