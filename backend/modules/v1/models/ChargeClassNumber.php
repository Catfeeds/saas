...
class ChargeClassNumber extends \backend\models\ChargeClassNumber
{
    ...
    public function getPrice()
    {
        switch (commonFunc::getRelationVal($this, 'chargeClass', 'type')){
            case 1:
                return commonFunc::getRelationVal($this, 'chargeClassPeople', 'pos_price') ?: '999999999.00';
                break;
            case 2:
                return number_format($this->total_class_num * $this->chargeClass->original_price, 2, '.', '');
                break;
            default:
                return '999999998.00';
                break;
