...
class LoginForm extends Model
{
    ...
    const  MEMBER_PIC = 'http://oo0oj2qmr.bkt.clouddn.com/headimg.png';
...
//            $member->companySignId = $this->companySignId;          // 公司标识id
            $this->member =  $member->getMemberOneData($mId);
            // 对pic 重新定义值
    ...
    {
        $card   = new MemberCard();
        $query  = $card->getAllMemberCard($this->member['id'],[1,2,3,4]);
