...
class BinkLandForm extends Model
{
    ...
    public function scenarios()
    {
        return [
            ...
            'bink' =>['type','openId','mobile','password',"companySign","venueId"],
            'sign' =>['type','openId','mobile','companyId','venueId','password',"code"],
        ];
    }
...
//                }
    ...
    public function setLandSignMember()
    {
        ...
        try {
            ...
            $member->username      = empty($this->nickname)?$this->mobile:$this->nickname;
...
//            $this->mobile = $member->mobile;
    ...
    {
        $fields = ['wx'=>'wx_open_id', 'qq'=>'qq_open_id', 'wb'=>'wb_open_id', 'alipay'=>'alipay_open_id'];
