...
class PaymentForm extends Model
{
    ...
    public function rules()
    {
        return [
            ...
            [['payTimes', 'firstPayMonths','num', 'typeId','type','firstPayPrice', 'monthPrice', 'amountMoney','idCard','payMethod',"coachId",'sign','saleMan'], 'safe'],
        ];
    }
...
//            }
        ...
        }elseif($this->paymentType=="zfbScanCode" || $this->paymentType == 'alipay' || $this->paymentType == 'zfb'){
    ...
    public function getMbScanConfig(){
        $config = array (
            ...
            //异步通知地址
            'notify_url' => "http://qa.aixingfu.net/member-ship-pay/ali-notify",

            //同步跳转
            'return_url' => "http://qa.aixingfu.net/member-ship/index",
