...
class AboutClassController extends BaseController
{
    ...
    public function prepareDataProvider()
    {
        ...
        $query = MyAboutClass::find()->where(['member_id'=>$memberId])->andWhere(['not in', 'status', [8,9]]);
    ...
    public function actionTable($coachId,$memberId,$start,$end)
    {
        ...
        $abouts = AboutClass::find()->where(['coach_id'=>$coachId, 'type'=>1])->andWhere(['between', 'start', $start, $end])->orderBy('start')->all();
