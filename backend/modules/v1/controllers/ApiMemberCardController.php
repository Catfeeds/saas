...
//        $judgeResult  =  $model->judgeMemberMessage($memberId);
     ...
     * ｝
     */
    public function actionGetCardCategoryDetail($cardCategoryId,$memberId="")
    {
        $model = new CardCategory();
     ...
     * @apiParam  {int}       identifyId              // 会员卡id 或 会员id
     ...
     * }
     */
    public function actionSearchMemberMessage($memberId=""){
        $model  = new Member();
        $member = $model->memberMessage($memberId);
