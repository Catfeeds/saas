...
<div class="row removeDiv">
    ...
    <div class="col-sm-4 clearfix">
        ...
        <button type="button" ng-click="removeVenueId(venueId<?=$num ;?>,'giftHtml123')" class="btn btn-white removeHtml" data-remove="removeDiv" style="position: absolute;top: -2px;right: 43px;">删除</button>
    </div>
</div>