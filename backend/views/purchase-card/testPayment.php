                ...
                <ul>
                    <li id="company" class="bgWhite" >
                        <div class="weui-flex js-category listForm" >
                            ...
                            <p  class="weui-flex-item f16Name mLF20">选择场馆<input class="selectInput" type="text" readonly="readonly" placeholder="请选择所属公司" ng-model="companyName"/></p>
...
<!--        <a style="width: 100%" class="btn btn-success" href="/payment/js-api">JSAPI支付</a>-->
        <button style="width: 100%" class="btn btn-success" ng-click="confirm()">登记购买</button>
    </div>
</main>
