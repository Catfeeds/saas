 ...
 * content:新增私教产品页面
 */
use backend\assets\PrivateTeachsCtrlAsset;
PrivateTeachsCtrlAsset::register($this);
$this->title = '新增多课种产品';
?>
<header class="reservation_header clearfix fw">
    <div class="w20  fl"><a href="/private-lesson/course" style="color: #ffffff">私教产品</a></div>
    <div class="fl">新增多课种产品</div>
</header>
<div class="yy_progress">
    <div class="progress"></div>
</div>
<div id="private" class="container-fluid" ng-controller="addProductCtrl" ng-cloak style=" background: #f5f5f5">
            ...
            <form action="" >
                <div class="row">
                    ...
                    <div class="col-sm-4 clearfix">
                        ...
                        <input  style="width:130px;" ng-model="validTime" type="number" inputnum min="0" placeholder="多少"  class="form-control fl cp" >
                        <select style="width: 70px;margin-left: 10px;" ng-model="validTimeType" class="form-control fl cp"  >
                    ...
                    <div class="col-sm-4 clearfix" id="unLimit">
                        ...
                        <div class="fl clearfix cp addUnlimited h32 inputSellNum" style="border: solid 1px #cfdadd;border-radius: 3px;">
                            <input name="sellNum" style="width:136px;border: none;margin-left: 0;padding-top: 0;padding-bottom: 0;margin-right: 0;" ng-model="totalSaleNum" type="number" inputnum min="0" placeholder="0套"  class="fl form-control">
                            <div class="checkbox i-checks checkbox-inline " style="top: 4px;margin-left: 2px;">
                                <label>
                                    <input ng-model="unLimitNum" type="checkbox" value="-1" > <i></i> 不限</label>
                            </div>
                        </div>
                    </div>
                ...
                <div id="course">
                    <div class="row">
                        ...
                        <div class="col-sm-4 clearfix">
                            ...
                            <input type="number"  inputnum min="0" ng-model="totalNum" ng-change="getPriceNum(price,totalNum)" name="classNum"  placeholder="0节" class="form-control cp fl">
                        </div>
                        <div class="col-sm-4 clearfix">
                            <span class="fl mT5"><strong class="red">*</strong>单节原价&emsp;&emsp;</span>
                            <input type="number" inputnum min="0" ng-model="price" ng-change="getPriceNum(price,totalNum)" name="unitPrice" placeholder="0元" class="form-control cp fl" style="margin-left: 10px">
                        </div>
                        <div class="col-sm-4 clearfix">
                            <span class="fl mT5">移动端单节原价&emsp;&emsp;</span>
                            <input type="number" inputnum min="0" ng-model="appPrice" ng-change="appPriceNum(appPrice,totalNum)" name="appUnitPrice" placeholder="0元" class="form-control cp fl" style="margin-left: -23px">
                        </div>
                    </div>
                </div>
            </form>
            <div class="row addPrivateCourse">
                <div class="col-sm-4 clearfix">
                    <span class="fl">&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;</span>
                    <button id="addPrivateCourse" ng-click="addClassHtml()" venuehtml="" class="btn btn-default fl" >添加课种</button>
                </div>
            </div>
        </div>

        <h4>3.产品价格
            <span class="glyphicon glyphicon-info-sign" style="font-weight: 100;font-size: 12px; color: darkgrey;">该课程总原价
                <b class="glyphicon glyphicon-yen" >{{classTotalPrice}}</b>元/金额
            </span>
            <span class="glyphicon glyphicon-info-sign" style="font-weight: 100;font-size: 12px; color: darkgrey;">该课程移动端总原价
                <b class="glyphicon glyphicon-yen" >{{classAppTotalPrice}}</b>元/金额
            </span>
        </h4>
        <div style="margin-top: 10px;">
            <form action="" >
                <div >
                    <div class="row">
                        <div class="col-sm-4 clearfix">
                            <span class="fl mT5">总售价&emsp;&emsp;&emsp;</span>
                            <input type="number" inputnum min="0" ng-model="totalSalePrice" placeholder="0元" class="form-control cp fl">
                        </div>
                        <div class="col-sm-4 clearfix">
                            <span class="fl mT5">总POS价&emsp;&emsp;</span>
                            <input type="number" inputnum ng-model="totalPosPrice" placeholder="0元" class="form-control cp fl">
                        </div>
                        <div class="col-sm-4 clearfix">
                            <span class="fl mT5">移动端总售价&emsp;&emsp;</span>
                            <input type="number" inputnum ng-model="appTotalPrice" placeholder="0元" class="form-control cp fl" style="margin-left: -8px;">
                        </div>
                    </div>
                </div>
            </form>
...
<!--                                    ng-disabled="venue.id | attrVenue:donationHttp">{{venue.name}}</option>-->
                            </select>
            ...
            <form action="" >
                <div class="row">
                    <div class="col-sm-4 clearfix">
                        ...
                        <input type="number" inputnum min="0" ng-model="transferNum" placeholder="几次" class="form-control cp fl" style="margin-left: 21px">
                    </div>
                    <div class="col-sm-4 clearfix">
