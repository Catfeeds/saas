 ...
 */
?>
<div class="createContent" ng-controller="createCtrl" ng-cloak style="height: 100%;background: #ffffff;">
    <div class="panel panel-default">
        <div class="panel-body">
            <a href="/action-library/index" class="mR10"><span><</span>返回</a>
            <span>生成动作</span>
        </div>
    </div>
    <div class="row mr0">
        <div class="col-md-12 mB10">
            ...
            <div class="col-md-2 pd0">
                <input type="text" style="width: 100%" class="form-control" placeholder="请输入名称，最多10位" id="typeName" ng-model="typeName">
            </div>
        </div>
        <div class="col-md-12 mB10">
            <div class="col-lg-1 col-md-2 text-right pL0">
        ...
        <div class="col-md-12 mB10">
            ...
            <div class="col-md-2 pd0" ng-if="drillType == 1">
                <select class="form-control selectStyle"  id="unit">
        ...
        <div class="col-md-12 mB10">
            ...
            <div class="col-md-2 pd0 mR10" ng-if="drillType == 1">
                <input type="number" inputnum  class="form-control "  placeholder="Kcal/分" id="expend">
            </div>
            <div class="col-md-2 pd0 mR10" ng-if="drillType != 1">
                <input type="number" inputnum  class="form-control"  placeholder="Kcal/次" ng-if="!chooseMin" id="expend">
                <input type="number" inputnum  class="form-control"  placeholder="Kcal/分钟" ng-if="chooseMin" id="expend">
            </div>
        ...
        <div class="col-md-12 mB10">
            ...
            <div class="col-lg-6 col-md-9 pd0">
                <textarea class="form-control" rows="4" id="gist"></textarea>
            </div>
        </div>
        <div class="col-md-12 mB10">
            <div class="col-lg-1 col-md-2 text-right pL0">
            ...
            <div class="col-lg-6 col-md-9 pd0 exampleDiv">
               ...
               <!-- <div class="w100 uploadDiv" ng-if="imgArr1.length == 0">
                    <div class="w100 imgDiv">
                        <img ng-src="/plugins/actionLibrary/img/22.png" ng-if="imgLink == '' || imgLink == null">
                        <img ng-src="{{imgLink}}" ng-if="imgLink != '' && imgLink != null" class="w100">
                    </div>
                    <textarea class="form-control detail" placeholder="文字说明:"></textarea>
                </div>-->
                <!--<div class="w100 uploadDiv mB10" ng-repeat="i in imgArr1" ng-if="imgArr1.length > 0">
                    <div class="w100 imgDiv">
        ...
        <div class="col-md-12 mB10">
            ...
            <div class="col-lg-6 col-md-9 pd0" style="border:1px solid #cfdadd;padding: 10px;">
                ...
                <div class="waringUploadDiv">
                    ...
                    <!--<div class="" style="position: relative;width: 320px; padding-bottom:86.25%; height: 0;" ng-if="videoSrc != ''" >
                        <video style="position: absolute;top:0;left: 0;" controls="controls">
        ...
        <div class="col-md-12 mB10">
            ...
            <div class="col-md-10 pd0">
                <button class="btn btn-info" style="width: 100px;" ng-click="submitBtn()" ng-disabled="disabledStatus">保存</button>
                <button class="btn btn-default" style="width: 100px;" ng-click="cancelBtn()">取消</button>
            </div>
        </div>
    </div>
</div>
