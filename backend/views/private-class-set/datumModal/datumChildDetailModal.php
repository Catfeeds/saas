 ...
 */
-->
<div class="modal fade" tabindex="-1" role="dialog" id="datumChildDetailModal">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-8 col-md-offset-2 mB10">
                        ...
                        <div class="col-md-8">{{detailDatumPro}}</div>
                    </div>
                    <div class="col-md-8 col-md-offset-2 mB10">
                        <div class="col-md-4">单位：</div>
                        <div class="col-md-8">{{detailDatumUnit | noData:''}}</div>
                    </div>
                    <div class="col-md-8 col-md-offset-2 mB10">
                        <div class="col-md-4">正常范围：</div>
                        <div class="col-md-8">{{detailDatumRange | noData:''}}</div>
                    </div>
                </div>
            </div>
