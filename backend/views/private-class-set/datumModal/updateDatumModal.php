...
-->
<!--修改体侧数据添加子级模态框-->
<div class="modal fade" tabindex="-1" role="dialog" id="updateDatumModal">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body pd50">
                <div class="row">
                    <div class="col-md-8 col-md-offset-2 pd0">
                        ...
                        <div class="col-lg-8">
                            <input type="text" class="form-control" ng-model="updateDatumName" placeholder="请输入名称，最多6个字">
                        </div>
                    </div>
                </div>
            </div>
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-success w100" ng-click="updateParentBtn()">完成</button>
            </div>
        </div>
    </div>
</div>
