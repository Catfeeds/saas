<?php
use backend\assets\RechargeableCardCtrlAsset;
RechargeableCardCtrlAsset::register($this);
$this->title = '充值卡';
?>

<div class="wrapper wrapper-content animated fadeInRight" ng-controller="rechargeCardCtrl">
    <div class="row">
            ...
            <div class="ibox float-e-margins"  style="min-width: 1240px;">
                ...
                <div class="ibox-content">
                    <div id="example-async">
                        ...
                        <section >
                            <!--属性内容-->
                            <div  class="fw text-center wB100"><h2>充值卡属性</h2></div>
                            <main class="con1 wB100 mB200 m0Auto" >
                                <div>
                                    <h4>1.卡的属性</h4>
                                    <form >
                                        <div class="clearfix" >
...
<!--                                                </select>-->
                                            ...
                                            <div class="fl  w32">
                                                ...
                                                <select id="rechargeCardType123" ng-model="$parent.cardType" class="form-control cp"  >
                                            ...
                                            <div class="fl   w32" >
                                                ...
                                                <input type="text" placeholder="至尊卡" class="form-control cp w198"
                                                       ng-blur="setCardName()"
                                                       ng-change="setCardName()"
                                                       ng-model="cardName"  >
                                            </div>
                                            <div class="f1 w32 " style="margin-right: 0px;padding-top: 20px;">
                                                <span class="w80" >卡别名</span>
                                                <input type="text" placeholder="英文名" class="form-control cp w202"
                                                       ng-model="anotherName" >
                                            </div>
                                            <div class="fl  w32 pRelative" >
                                                <span style="width: 85px;" class="w80"><strong class=" red">*</strong>充值金额</span>
                                                <input  type="number"
                                                        placeholder="充值金额"
                                                        ng-model="rechargePrice"
                                                        ng-keyup="calculation(rechargePrice)"
                                                        min="0"
                                                        class="form-control cp w90">
                                                <span  class="m5">赠</span>
                                                <input style="width: 85px !important;"  type="number" placeholder="赠送金额"
                                                       ng-model="rechargeGivePrice"
                                                       ng-keyup="calculation()"
                                                       min="0"
                                                       class="form-control cp mL0 w90">
                                                <p class="allMoney">总金额&nbsp;<span><b ng-bind="total_price">0</b></span>&nbsp;元</p>
                                            </div>
                                            <div class="fl  w32">
                                                <span class="w80"><strong class=" red">*</strong>激活期限&emsp;</span>
                                                <input   inputnum type="number" min="0" ng-model="activeTime" placeholder="多少" class="form-control cp w115">
                                                <select  class="form-control cp w68"  ng-model="activeTimeType">
                                            ...
                                            <div class="fl  w32">
                                                <span class=""><strong class=" red">*</strong>有效天数</span>
                                                <input   inputnum type="number" min="0" placeholder="多少" ng-model="duration" class="form-control cp w115 mL38" >
                                                <select  class="form-control cp w70" ng-model="durationType" >
                                                    <option value="1">天</option>
                                                    <option value="7">周</option>
                                                    <option value="30">月</option>
                                                    <option value="90">季</option>
                                            ...
                                            <div class="f1 w32" style="margin-top: 85px;">
                                                <span style="width: 85px;" class=""><strong style="opacity: 0;">*</strong>单数&emsp;&emsp;</span>
<!--                                                <input type="text" placeholder="请输入单数" class="form-control cp w202"-->
<!--                                                       ng-model="Singular" >-->
                                                <input id="Singular" type="number"  ng-model="Singular" min="0" placeholder="请输入单数" class="form-control cp w202">
                                            </div>
                                            <div class="w100 cp">
                                                <div class="col-sm-8 clearfix">
                                                    <span class="fl mT5" style="margin-top: 35px;margin-left: -12px">&nbsp;卡种照片&emsp;</span>
                                                    <div class="form-group">
                                                        <img ng-src="{{pic}}" class='photo mL120W100H100' style="width: 100px;height: 100px;margin-top: 14px;margin-left: 14px">
                                                    </div>
                                ...
                                <div class="mT60" >
                                    ...
                                    <form >
                                        <div class="w100 cp">
                                            <span ><strong class=" red">*</strong>一口价&emsp;&emsp;&emsp;</span>
                                            <input   type="number" min="0" placeholder="原价0元" ng-disabled="disabled" ng-change="setDisabled(disabled,unable)" ng-model="originalPrice" class="form-control w125">
                                            <input   type="number" min="0" placeholder="售价0元" ng-disabled="disabled" ng-change="setDisabled(disabled,unable)" ng-model="sellPrice" class="form-control w125">
                                        </div>
                                        <div class="w100  cp">
                                            <span><strong class=" red">*</strong>区域定价&emsp;&emsp;</span>
                                            <input   type="number" min="0" ng-model="minPrice" ng-disabled="unable" ng-change="setUnable(disabled,unable)" placeholder="最低价0元" class="form-control w125">
                                            <input   type="number" min="0" ng-model="maxPrice" ng-disabled="unable" ng-change="setUnable(disabled,unable)" placeholder="最高价0元" class="form-control w125">
                                        </div>
<!--                                        <div class="w100  cp">-->
<!--                                            <span >续费价&emsp;&emsp;&emsp;</span>-->
<!--                                            <input   inputnum type="number" min="0" ng-model="renewPrice" placeholder="0元" class="form-control w125">-->
...
<!--                                        </div>-->
                                        <div class="w100 cp">
                                            <span >优惠价&emsp;&emsp;&emsp;</span>
                                            <input type="number" min="0" ng-model="offerPrice" placeholder="0元" class="form-control w125">
                                        </div>
                                        <div class="w100 cp" style="margin-bottom: 10px;">
                                            <span >移动端售价&emsp;</span>
                                            <input type="number" min="0" ng-model="appSellPrice" placeholder="0元" class="form-control w125">
                                        </div>
                                        ...
                                        <div style="width: 100%;" class="cardValidity123">
                                            <div style="width: 100%;" class="cardValidityBox">
                                                <div style="width: 100%; display: flex;margin-top: 15px;">
                                                    <span class="" style="width: 95px;margin-top: 5px;">有效期续费&emsp;</span>
                                ...
                                <div class="mT60">
                                    ...
                                    <form >
                                        <div id="sellVenue">
                                            <div class="clearfix sellVenueLists123" >
                                                <div class="fl  w32 pRelative" >
                                                    <span class=""><strong class=" red">*</strong>选择场馆&emsp;&emsp;</span>
                                                    <select ng-if="venueStatus == true" ng-change="selectVenue(venueId)" ng-model="$parent.venueId" class="form-control cp">
                                                        <option value="">请选择场馆</option>
...
<!--                                                </div>-->
                                                <div class="fl  w32">
                                                    <span class=""><strong class="red">*</strong>售卖张数&emsp;&emsp;</span>
                                                    <div class="clearfix limitNum123 cp h32 inputUnlimited unDivBorder" >
                                                        <input type="number"  inputnum name="sheets" min="0" value="" placeholder="0张" class="mp0 fl form-control pT0 unDivBorderInput">
                                                ...
                                                <div class="fl  w32 input-daterange cp pRelative" >
                                                    <span class=""><strong class=" red">*</strong>售卖日期&emsp;</span>
                                                    <b><input type="text"  class="input-sm form-control datetimeStart dateCss" name="start" placeholder="起始日期"  ></b>
                                                    <b><input type="text"  class="input-sm form-control datetimeEnd dateCss" name="end" placeholder="结束日期" ></b>
                                                </div>
                                                    ...
                                                    <div class=" clearfix discountBox" style="width: 100%;">
                                                        ...
                                                        <div class="fl  w32">
                                                            ...
                                                            <div class=" cp h32 inputUnlimited unDivBorder" >
                                                                ...
                                                                <div class="checkbox i-checks checkbox-inline t4" >
                                                                    <label>
                                                                        <input style="width: 10px;" type="checkbox" value="" name="discountNumLimit"> <i></i> 不限</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div id="addSellVenue" class="cardAddBtn btn btn-default" ng-click="addVenueHtml()" venuehtml="">添加场馆</div>
                                    </form>
                                </div>
                                        ...
                                        <div id="venue">
                                            <div class="clearfix" >
                                                ...
                                                <div class="fl  w32 month">
                                                    ...
                                                    <div class="clearfix cp inputUnlimited unDivBorder" style="display: flex;height: 32px;">
                                                        <input style="height: 28px;"   type="number" inputnum min="0" placeholder="通店次数" name="times" class="mp0 fl form-control unDivBorderInput">
                                                        <div class="checkbox i-checks checkbox-inline " style="margin-top: 4px;margin-right: 0px;">
                                                            <label>
                                                                <input style="width: 6px;" type="checkbox" value="-1" ng-model="applyTimes"> <i></i> 不限</label>
                                                        </div>
                                                    </div>
                                                    <select  class="form-control cp w70" name="weeks" style="margin-left: 15px">
...
<!--                                                        <input   type="number" inputnum min="0" placeholder="通店次数" name="weeks" class="mp0 fl form-control unDivBorderInput">-->
<!--                                                        <div class="checkbox i-checks checkbox-inline t4" >-->
<!--                                                            <label>-->
...
<!--                                                </div>-->
                                        ...
                                        <div id="addVenue"  ng-click="addApplyHtml()" class="btn btn-default cardAddBtn" venuehtml="">添加场馆</div>
                                    </form>
                                </div>
                                <div class="mTB60" >
                            ...
                            <main class="con1 wB100 mB20 mL20p">
                                <div>
                                    ...
                                    <form action="">
                                        <div class="course" id="course">
                                            <div class="clearfix" >
                                                ...
                                                <div class="fl  w32">
                                                    ...
                                                    <div class="clearfix cp h32 inputUnlimited unDivBorder" >
                                                        <input   type="number" inputnum min="0" name="times" placeholder="0节" class="fl form-control pT0 unDivBorderInput">
                                                        <div class="checkbox i-checks checkbox-inline t4" >
                                                            <label>
                                        ...
                                        <div id="addCourse" ng-click="addClassHtml()"  class="btn btn-default addCourse mT15 mL93" venuehtml="">添加课程</div>
                                    </form>
                                </div>
                                <!-- 绑定私课-->
                                <div>
                                    ...
                                    <form >
                                        <div class="course"  id="pTcourse">
                                            <div class="clearfix" >
                                                ...
                                                <div class="fl  w32">
                                                    <span class="w80">HS节数&emsp;&emsp;</span>
                                                    <div class=" cp h32 "  >
                                            ...
                                            <div class="clearfix" >
                                                ...
                                                <div class="fl  w32">
                                                    <span class="w80">PT节数&emsp;&emsp;</span>
                                                    <div class=" cp h32 "  >
                                            ...
                                            <div class="clearfix" >
                                                ...
                                                <div class="fl  w32">
                                                    <span class="w80">生日课节数&emsp;</span>
                                                    <div class=" cp h32 "  >
                                ...
                                <div class="mT15" ng-show="serverShow">
                                    ...
                                    <form action="">
                                        <div class="serve" id="server">
                                            <div class="clearfix" >
                                                ...
                                                <div class="fl  w32">
                                                    ...
                                                    <div class="clearfix cp h32 inputUnlimited unDivBorder" >
                                                        <input   type="number" inputnum min="0" name="times" placeholder="0" class="fl form-control pT0 unDivBorderInput">
                                                        <div class="checkbox i-checks checkbox-inline t4" >
                                                            <label>
                                                                <input type="checkbox" value="-1"> <i></i> 不限</label>
                                                        </div>
                                        ...
                                        <div id="addServer" ng-click="addServerHtml()"  class="btn btn-default addServe mT15 mL93" venuehtml="">添加服务</div>
                                    </form>
                                </div>
                                        ...
                                        <div class="shopping" id="shopping">
                                            <div class="clearfix" >
                                                <div class="fl  w32 pRelative" >
                                                    ...
                                                    <select  ng-if="shopStatus == true" ng-change="selectShop(shopKey)" ng-model="$parent.shopKey" class="form-control cp">
                                                ...
                                                <div class="fl  w32">
                                                    ...
                                                    <div class="clearfix cp h32 inputUnlimited unDivBorder">
                                                        <input   type="number" inputnum min="0" name="times" placeholder="0个" class="fl form-control pT0 unDivBorderInput">
                                                        <div class="checkbox i-checks checkbox-inline t4">
                                                            <label>
                                                                <input type="checkbox" value="-1"> <i></i> 不限</label>
                                                        </div>
                                                ...
                                                <div class="fl mT26 mLF60" ><span class="glyphicon glyphicon-yen"><b class="f18">0</b></span> 总金额</div>
                                            </div>
                                        </div>
                                        <div id="addShop" ng-click="addShopHtml()"  class="btn btn-default addShop mT15 mL93" venuehtml="">添加商品</div>
                                    </form>
                                </div>
                                ...
                                <div class="mT15" ng-show="donationShow">
                                    ...
                                    <form action="">
                                        <div class="donation" id="donation">
                                            <div class="clearfix" >
                                                <div class="fl  w32 pRelative" >
                                                    <span class="">商品名称&emsp;&emsp;</span>
                                                ...
                                                <div class="fl  w32">
                                                    ...
                                                    <div class="clearfix cp h32 inputUnlimited unDivBorder" >
                                                        <input   type="number" inputnum min="0" placeholder="0个" name="times" class="fl form-control pT0 unDivBorderInput">
                                                        <div class="checkbox i-checks checkbox-inline t4" >
                                                            <label>
                                                                <input type="checkbox" value="-1"> <i></i> 不限</label>
                                                        </div>
                                        ...
                                        <div id="addDonation" ng-click="addDonationHtml()"  class="btn mT15 mL93 btn-default addDonation" venuehtml="">添加商品</div>
                                    </form>
                                </div>
                            </main>
                        </section>
                                    ...
                                    <form >
                                        <div class="clearfix" >
                                            <div class="fl  w32">
                                                ...
                                                <input type="number" checknum min="0" ng-model="transferNumber" placeholder="0次" class="form-control">
                                            </div>
                                            <div class="fl  w32">
                                    ...
                                    <form >
                                        <div class="clearfix" >
                                            <div class="fl  w32">
                                                ...
                                                <input type="number" checknum min="0" ng-disabled="leaveDaysFlag" ng-change="setLeaveNumDisabled(leaveDaysTotal)" ng-model="leaveDaysTotal" id="leaveDaysTotal" placeholder="0次" class="form-control">
                                            </div>
                                            <div class="fl  w32">
                                                <span class="">每次最低天数</span>
                                                <input type="number" checknum min="0" ng-disabled="leaveDaysFlag" ng-change="setLeaveNumDisabled(leaveTimesTotal)" ng-model="leaveTimesTotal" id="leaveTimesTotal" placeholder="0天" class="form-control">
                                            </div>
                                        </div>
                                        <hr class="mT15 wB60" >
                                        <div class="leaveDay" id="leaveDay">
                                            <div class="clearfix">
                                                <div class="fl  w32">
                                                    ...
                                                    <input type="number" checknum ng-disabled="leaveNumsFlag" ng-model="leaveNums"  ng-change="setLeaveDaysDisabled(leaveNums)" min="0" name="times"  placeholder="0次" class="form-control">
                                                </div>
                                                <div class="fl  w32">
                                                    <span class="">每次请假天数</span>
                                                    <input type="number" checknum ng-disabled="leaveNumsFlag" ng-model="everyLeaveDays"   ng-change="setLeaveDaysDisabled(everyLeaveDays)" min="0" name="days" placeholder="0天" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        <button id="addLeave" type="button" ng-disabled="leaveNumsFlag"  ng-click="addLeaveHtml()" class="btn mT15 mL93 btn-default addLeave" venuehtml="">添加请假</button>
                                    </form>
                                </div>
                            </main>
                        </section>
                            ...
                            <main class="con1">
                                <div class=" wB80 m0Auto" >
                                    <div class="clearfix wB20 text-center m0Auto" >
                                        <span class="fl mT20 mB5" >请选择合同</span><br>
                        ...
                        <div  class="form-group mT10">
                            <div class=" input-daterange cp timeModalCss" >
                                <div class="input-group clockpicker wB45 zIndex11" data-autoclose="true"  >
                                    <input type="text" id="weekStart" class="input-sm form-control text-center timeCss"  placeholder="起始时间" >
                                </div>
                                <div class="input-group clockpicker wB45 zIndex11" data-autoclose="true" >
