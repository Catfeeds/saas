    ...
    <div class="fl  w32">
        ...
        <div class=" cp h32 inputUnlimited unDivBorder" >
            <input
                ...
                type="number" inputnum name="discountNum" min="1" value="" placeholder="0张" class="mp0 fl form-control pT0 unDivBorderInput">
            <div class="checkbox i-checks checkbox-inline t4 hF4" >
                <label>
                    <input type="checkbox" style="width: 20px!important;" value="" name="discountNumLimit"> <i></i> 不限</label>
            </div>
        </div>
    </div>
    <div class="fl w32">
