 ...
 */
?>
<div class="updateTemplateMain" ng-controller="updateTemplateCtrl" ng-cloak>
    ...
    <div class="row mr0">
        ...
        <div class="col-md-12 mB10">
           ...
           <div class="templateBig col-lg-7 col-md-11 mB10 ">
                <div class="col-md-12 templateDiv fl mB10 pd0 removeTemplate"  ng-repeat="($index,w) in stages">
                    ...
                    <div class="col-lg-8 col-md-10 pd0">
                        <div class="col-md-12 pd0 mB10 mT10 stageNameDiv">
                            ...
                            <div class="col-md-5">
                                <input type="text" class="form-control stageName" placeholder="请输入阶段名称" value="{{w.title}}">
                            </div>
                        </div>
                        <div class="col-md-12 pd0 mB10 stageTimeDiv">
                            ...
                            <div class="col-md-5">
                                <input type="text" inputnum min="1" class="form-control stageTime" placeholder="分钟" value="{{w.length_time}}">
                            </div>
                        </div>
                        <div class="col-md-12 pd0 mB10">
                            ...
                            <div class="col-lg-8 col-md-8 mL15 pd0 drillDiv" style="border:1px solid #c0bfc4">
                                <div class="row mr0 oneDrill removeDrill" ng-repeat="a in w.main">
                                    ...
                                    <div class="col-md-12 mB10">
                                        ...
                                        <div class="fl mL15">
                                            <input type="text" inputnum min="1" class="form-control setNum" placeholder="组数或分钟" value="{{a.number}}">
                                        </div>
                                    </div>
                                    <div class="col-md-12 mB10" ng-if="$index != 0">
                                        <div class="fl w60" style="height: 30px;"></div>
                                        <div class="fl mL15">
                                            <button class="btn btn-default w100 removeHtml" data-remove="removeDrill">删除</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-md-12 mB10 text-right" ng-if="$index != 0">
                        <button class="btn btn-default w100 removeHtml"  data-remove="removeTemplate">删除</button>
                    </div>
                </div>
            </div>
    ...
    <div class="row mr0 mT10">
        <div class="col-md-12 mB10">
            <div class="col-md-3 pd0">
                ...
                <div class="col-md-8">
                    <button class="btn btn-success w100" ng-click="updateSubmitBtn()">保存</button>
                    <button class="btn btn-default w100" ng-click="updateCancelBtn()">取消</button>
                </div>
            </div>
        </div>
    </div>
