                ...
                <div class="row ">
                    ...
                    <div class="form-group  col-sm-12  mT20">
                        <div class="col-sm-4  text-right">
                            <div for="recipient-name" class="control-label LH30"><span class="red">*</span>定金类型:</div>
                        </div>
                    ...
                    <div class="form-group  col-sm-12   mT20">
                        <div class="col-sm-4   text-right">
                            <div for="recipient-name" class="control-label LH30"><span class="red">*</span>金额:</div>
                        </div>
                        <div class="col-sm-6 pd0">
                    ...
                    <div class="form-group  col-sm-12  mT20">
                        <div class="col-sm-4  text-right">
                            <div for="recipient-name" class="control-label LH30"><span class="red">*</span>有效期:</div>
                        </div>
                        <div class="col-sm-6 pd0" >
                    ...
                    <div class="form-group  col-sm-12  mT20">
                        <div class="col-sm-4  text-right">
                            <div for="recipient-name" class="control-label LH30"><span class="red">*</span>付款方式:</div>
                        </div>
                        <div class="col-sm-6 pd0" >
                            <select  class="form-control"  style="padding: 4px 12px;" disabled="disabled" ng-model="updatePayType">
                    ...
                    <div class="form-group  col-sm-12  mT20">
                        <div class="col-sm-4  text-right">
                            <div for="recipient-name" class="control-label LH30"><span class="red">*</span>
                                <span ng-if="updateDepositType == 2">选择私教:</span>
                                <span ng-if="updateDepositType != 2">选择销售:</span>
                            </div>
                        </div>
                        <div class="col-sm-6 pd0" >
                            <select ng-model="updateSellName"  disabled="disabled" class="form-control" style="padding: 4px 12px;">
                                <option value="" ng-if="updateDepositType == 2">请选择私教</option>
                                <option value="" ng-if="updateDepositType != 2">请选择销售</option>
