    ...
    <div class="modal-dialog">
        <div class="modal-content clearfix">
            ...
            <div class="modal-body text-center" style="margin-top: 25px;">
                <div class="form-group mL120 color999" style="display: inline-block;margin-left: 0;">服务名称<span class="red">*</span>：&nbsp;&nbsp;</div>
                <div class="form-group text-center mL120" style="display: inline-block;margin-left: 0;">
                    <input type="text" ng-model="serverName" value="" class="form-control actions w300" id=""
                           placeholder="服务名称">
                </div>
            </div>
