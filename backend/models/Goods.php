   ...
   public function getVenueGoods($type,$id){
    ...
    public function search($params)
    {
        ...
        $query = Goods::find()
            ...
            ->joinWith(['department department'],false)
            ->select(
                "
    ...
    public function customLoads($data)
    {
        ...
        $this->venueIds     = (isset($data[self::VENUE_IDS]) && !empty($data[self::VENUE_IDS]))?$data[self::VENUE_IDS]: NULL;
        $this->sorts = self::loadSorts($data);
        $this->department_id = (isset($data['department_id']) && !empty($data['department_id']))?$data['department_id']: NULL;
    ...
    public function getSearchWheres($query)
    {
        ...
        $query->andFilterWhere(['goods.venue_id'=>$this->venueIds]);
